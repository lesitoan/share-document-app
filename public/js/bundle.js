...
var handleUploadForm = exports.handleUploadForm = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var name, school, academic, type, formData, url, response;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          type = function () {
            var typeElement = document.getElementsByName('type');
            for (var i = 0; i < typeElement.length; i++) {
              if (typeElement[i].checked) return Number(typeElement[i].value);
            }
            return 0;
          }();
