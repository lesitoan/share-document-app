...
},{"./cookie":"cookie.js"}],"handleUserPage.js":[function(require,module,exports) {
"use strict";
...
if (deltaiPage) {
  ...
  function _getDoc() {
    _getDoc = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      var pdffile, page, pdfCanvas, context, viewport, outputScale, renderContext;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return pdfjsLib.getDocument('/pdf/1718131083720-367.pdf').promise;
          case 2:
            pdffile = _context.sent;
            _context.next = 5;
            return pdffile.getPage(1);
          case 5:
            page = _context.sent;
  ...
  getDoc().then(function (data) {
    console.log("data: ", data);
  });
}
},{"./handleUploadPage":"handleUploadPage.js","./handleLoginPage":"handleLoginPage.js","./handleSearchDocs":"handleSearchDocs.js","./pagination":"pagination.js","./setAvatar":"setAvatar.js","./handleUserPage":"handleUserPage.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
