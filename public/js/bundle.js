...
exports.Axios = Axios;
},{"./lib/axios.js":"../../node_modules/axios/lib/axios.js"}],"cookie.js":[function(require,module,exports) {
"use strict";
...
var getCookieValue = exports.getCookieValue = function getCookieValue(name) {
...
},{}],"callApi.js":[function(require,module,exports) {
"use strict";
...
var getNewAccessToken = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var _response$data, refreshToken, url, response;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          refreshToken = (0, _cookie.getCookieValue)("refreshToken");
          url = "".concat(window.location.origin, "/api/v1/users/refresh-token");
          _context.next = 5;
        ...
        case 5:
          ...
          if (!((_response$data = response.data) !== null && _response$data !== void 0 && (_response$data = _response$data.data) !== null && _response$data !== void 0 && _response$data.newAccessToken)) {
            _context.next = 8;
            break;
          }
          return _context.abrupt("return", response.data.data.newAccessToken);
        case 8:
          _context.next = 14;
          break;
        case 10:
          ...
          console.log("err refreshtoken: ", _context.t0);
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 7:
          ...
          console.log("err GetData: ", _context2.t0);
...
var callApi = exports.callApi = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 9:
          ...
          (0, _cookie.setCookie)('accessToken', newAccessToken);
        ...
        case 19:
          console.log('abc');
          (0, _cookie.setCookie)('accessToken', "");
          (0, _cookie.setCookie)('refreshToken', "");
          (0, _cookie.setCookie)('name', "");
        ...
        case 29:
          ...
          console.log("callApi err: ", _context3.t0);
  ...
  return function callApi(_x3, _x4) {
    return _ref3.apply(this, arguments);
  };
}();
},{"axios":"../../node_modules/axios/index.js","./cookie":"cookie.js"}],"handleUploadPage.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.handleUploadForm = void 0;
var _callApi = require("./callApi");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _regeneratorRuntime() { "use strict"; /*! regenerator-runtime -- Copyright (c) 2014-present, Facebook, Inc. -- license (MIT): https://github.com/facebook/regenerator/blob/main/LICENSE */ _regeneratorRuntime = function _regeneratorRuntime() { return e; }; var t, e = {}, r = Object.prototype, n = r.hasOwnProperty, o = Object.defineProperty || function (t, e, r) { t[e] = r.value; }, i = "function" == typeof Symbol ? Symbol : {}, a = i.iterator || "@@iterator", c = i.asyncIterator || "@@asyncIterator", u = i.toStringTag || "@@toStringTag"; function define(t, e, r) { return Object.defineProperty(t, e, { value: r, enumerable: !0, configurable: !0, writable: !0 }), t[e]; } try { define({}, ""); } catch (t) { define = function define(t, e, r) { return t[e] = r; }; } function wrap(t, e, r, n) { var i = e && e.prototype instanceof Generator ? e : Generator, a = Object.create(i.prototype), c = new Context(n || []); return o(a, "_invoke", { value: makeInvokeMethod(t, r, c) }), a; } function tryCatch(t, e, r) { try { return { type: "normal", arg: t.call(e, r) }; } catch (t) { return { type: "throw", arg: t }; } } e.wrap = wrap; var h = "suspendedStart", l = "suspendedYield", f = "executing", s = "completed", y = {}; function Generator() {} function GeneratorFunction() {} function GeneratorFunctionPrototype() {} var p = {}; define(p, a, function () { return this; }); var d = Object.getPrototypeOf, v = d && d(d(values([]))); v && v !== r && n.call(v, a) && (p = v); var g = GeneratorFunctionPrototype.prototype = Generator.prototype = Object.create(p); function defineIteratorMethods(t) { ["next", "throw", "return"].forEach(function (e) { define(t, e, function (t) { return this._invoke(e, t); }); }); } function AsyncIterator(t, e) { function invoke(r, o, i, a) { var c = tryCatch(t[r], t, o); if ("throw" !== c.type) { var u = c.arg, h = u.value; return h && "object" == _typeof(h) && n.call(h, "__await") ? e.resolve(h.__await).then(function (t) { invoke("next", t, i, a); }, function (t) { invoke("throw", t, i, a); }) : e.resolve(h).then(function (t) { u.value = t, i(u); }, function (t) { return invoke("throw", t, i, a); }); } a(c.arg); } var r; o(this, "_invoke", { value: function value(t, n) { function callInvokeWithMethodAndArg() { return new e(function (e, r) { invoke(t, n, e, r); }); } return r = r ? r.then(callInvokeWithMethodAndArg, callInvokeWithMethodAndArg) : callInvokeWithMethodAndArg(); } }); } function makeInvokeMethod(e, r, n) { var o = h; return function (i, a) { if (o === f) throw Error("Generator is already running"); if (o === s) { if ("throw" === i) throw a; return { value: t, done: !0 }; } for (n.method = i, n.arg = a;;) { var c = n.delegate; if (c) { var u = maybeInvokeDelegate(c, n); if (u) { if (u === y) continue; return u; } } if ("next" === n.method) n.sent = n._sent = n.arg;else if ("throw" === n.method) { if (o === h) throw o = s, n.arg; n.dispatchException(n.arg); } else "return" === n.method && n.abrupt("return", n.arg); o = f; var p = tryCatch(e, r, n); if ("normal" === p.type) { if (o = n.done ? s : l, p.arg === y) continue; return { value: p.arg, done: n.done }; } "throw" === p.type && (o = s, n.method = "throw", n.arg = p.arg); } }; } function maybeInvokeDelegate(e, r) { var n = r.method, o = e.iterator[n]; if (o === t) return r.delegate = null, "throw" === n && e.iterator.return && (r.method = "return", r.arg = t, maybeInvokeDelegate(e, r), "throw" === r.method) || "return" !== n && (r.method = "throw", r.arg = new TypeError("The iterator does not provide a '" + n + "' method")), y; var i = tryCatch(o, e.iterator, r.arg); if ("throw" === i.type) return r.method = "throw", r.arg = i.arg, r.delegate = null, y; var a = i.arg; return a ? a.done ? (r[e.resultName] = a.value, r.next = e.nextLoc, "return" !== r.method && (r.method = "next", r.arg = t), r.delegate = null, y) : a : (r.method = "throw", r.arg = new TypeError("iterator result is not an object"), r.delegate = null, y); } function pushTryEntry(t) { var e = { tryLoc: t[0] }; 1 in t && (e.catchLoc = t[1]), 2 in t && (e.finallyLoc = t[2], e.afterLoc = t[3]), this.tryEntries.push(e); } function resetTryEntry(t) { var e = t.completion || {}; e.type = "normal", delete e.arg, t.completion = e; } function Context(t) { this.tryEntries = [{ tryLoc: "root" }], t.forEach(pushTryEntry, this), this.reset(!0); } function values(e) { if (e || "" === e) { var r = e[a]; if (r) return r.call(e); if ("function" == typeof e.next) return e; if (!isNaN(e.length)) { var o = -1, i = function next() { for (; ++o < e.length;) if (n.call(e, o)) return next.value = e[o], next.done = !1, next; return next.value = t, next.done = !0, next; }; return i.next = i; } } throw new TypeError(_typeof(e) + " is not iterable"); } return GeneratorFunction.prototype = GeneratorFunctionPrototype, o(g, "constructor", { value: GeneratorFunctionPrototype, configurable: !0 }), o(GeneratorFunctionPrototype, "constructor", { value: GeneratorFunction, configurable: !0 }), GeneratorFunction.displayName = define(GeneratorFunctionPrototype, u, "GeneratorFunction"), e.isGeneratorFunction = function (t) { var e = "function" == typeof t && t.constructor; return !!e && (e === GeneratorFunction || "GeneratorFunction" === (e.displayName || e.name)); }, e.mark = function (t) { return Object.setPrototypeOf ? Object.setPrototypeOf(t, GeneratorFunctionPrototype) : (t.__proto__ = GeneratorFunctionPrototype, define(t, u, "GeneratorFunction")), t.prototype = Object.create(g), t; }, e.awrap = function (t) { return { __await: t }; }, defineIteratorMethods(AsyncIterator.prototype), define(AsyncIterator.prototype, c, function () { return this; }), e.AsyncIterator = AsyncIterator, e.async = function (t, r, n, o, i) { void 0 === i && (i = Promise); var a = new AsyncIterator(wrap(t, r, n, o), i); return e.isGeneratorFunction(r) ? a : a.next().then(function (t) { return t.done ? t.value : a.next(); }); }, defineIteratorMethods(g), define(g, u, "Generator"), define(g, a, function () { return this; }), define(g, "toString", function () { return "[object Generator]"; }), e.keys = function (t) { var e = Object(t), r = []; for (var n in e) r.push(n); return r.reverse(), function next() { for (; r.length;) { var t = r.pop(); if (t in e) return next.value = t, next.done = !1, next; } return next.done = !0, next; }; }, e.values = values, Context.prototype = { constructor: Context, reset: function reset(e) { if (this.prev = 0, this.next = 0, this.sent = this._sent = t, this.done = !1, this.delegate = null, this.method = "next", this.arg = t, this.tryEntries.forEach(resetTryEntry), !e) for (var r in this) "t" === r.charAt(0) && n.call(this, r) && !isNaN(+r.slice(1)) && (this[r] = t); }, stop: function stop() { this.done = !0; var t = this.tryEntries[0].completion; if ("throw" === t.type) throw t.arg; return this.rval; }, dispatchException: function dispatchException(e) { if (this.done) throw e; var r = this; function handle(n, o) { return a.type = "throw", a.arg = e, r.next = n, o && (r.method = "next", r.arg = t), !!o; } for (var o = this.tryEntries.length - 1; o >= 0; --o) { var i = this.tryEntries[o], a = i.completion; if ("root" === i.tryLoc) return handle("end"); if (i.tryLoc <= this.prev) { var c = n.call(i, "catchLoc"), u = n.call(i, "finallyLoc"); if (c && u) { if (this.prev < i.catchLoc) return handle(i.catchLoc, !0); if (this.prev < i.finallyLoc) return handle(i.finallyLoc); } else if (c) { if (this.prev < i.catchLoc) return handle(i.catchLoc, !0); } else { if (!u) throw Error("try statement without catch or finally"); if (this.prev < i.finallyLoc) return handle(i.finallyLoc); } } } }, abrupt: function abrupt(t, e) { for (var r = this.tryEntries.length - 1; r >= 0; --r) { var o = this.tryEntries[r]; if (o.tryLoc <= this.prev && n.call(o, "finallyLoc") && this.prev < o.finallyLoc) { var i = o; break; } } i && ("break" === t || "continue" === t) && i.tryLoc <= e && e <= i.finallyLoc && (i = null); var a = i ? i.completion : {}; return a.type = t, a.arg = e, i ? (this.method = "next", this.next = i.finallyLoc, y) : this.complete(a); }, complete: function complete(t, e) { if ("throw" === t.type) throw t.arg; return "break" === t.type || "continue" === t.type ? this.next = t.arg : "return" === t.type ? (this.rval = this.arg = t.arg, this.method = "return", this.next = "end") : "normal" === t.type && e && (this.next = e), y; }, finish: function finish(t) { for (var e = this.tryEntries.length - 1; e >= 0; --e) { var r = this.tryEntries[e]; if (r.finallyLoc === t) return this.complete(r.completion, r.afterLoc), resetTryEntry(r), y; } }, catch: function _catch(t) { for (var e = this.tryEntries.length - 1; e >= 0; --e) { var r = this.tryEntries[e]; if (r.tryLoc === t) { var n = r.completion; if ("throw" === n.type) { var o = n.arg; resetTryEntry(r); } return o; } } throw Error("illegal catch attempt"); }, delegateYield: function delegateYield(e, r, n) { return this.delegate = { iterator: values(e), resultName: r, nextLoc: n }, "next" === this.method && (this.arg = t), y; } }, e; }
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var handleUploadForm = exports.handleUploadForm = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var name, school, academic, formData, url, response;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          ...
          academic = document.querySelector('.academic').value; // const type = (() => {
        ...
        case 8:
          ...
          url = "".concat(window.location.origin, "/api/v1/docs/upload");
          _context.next = 15;
          return (0, _callApi.callApi)(url, {
            method: "POST",
            data: formData,
            headers: {
              "Content-Type": "multipart/form-data"
  ...
  return function handleUploadForm() {
    return _ref.apply(this, arguments);
  };
}();
},{"./callApi":"callApi.js"}],"handleLoginPage.js":[function(require,module,exports) {
"use strict";
...
var signIn = exports.signIn = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var email, password, url, response, _response$data$data$u, _response$data$data$u2, _response$data$data$u3;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          email = document.querySelector('.form-login__email').value;
          password = document.querySelector('.form-login__password').value;
          url = "".concat(window.location.origin, "/api/v1/users/sign-in");
          _context.next = 6;
          return (0, _callApi.callApi)(url, {
            method: "POST",
            data: {
        ...
        case 6:
          ...
          (0, _cookie.setCookie)("name", (_response$data$data$u = response.data.data.user) === null || _response$data$data$u === void 0 ? void 0 : _response$data$data$u.userName);
          (0, _cookie.setCookie)("accessToken", (_response$data$data$u2 = response.data.data.user) === null || _response$data$data$u2 === void 0 ? void 0 : _response$data$data$u2.accessToken);
          (0, _cookie.setCookie)("refreshToken", (_response$data$data$u3 = response.data.data.user) === null || _response$data$data$u3 === void 0 ? void 0 : _response$data$data$u3.refreshToken);
...
var signUp = exports.signUp = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var userName, email, password, passwordConfirm, url, response;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          userName = document.querySelector('.form-login__userName').value;
          email = document.querySelector('.form-login__email').value;
          password = document.querySelector('.form-login__password').value;
          passwordConfirm = document.querySelector('.form-login__passwordConfirm').value;
          url = "".concat(window.location.origin, "/api/v1/users/sign-up");
          _context2.next = 8;
          return (0, _callApi.callApi)(url, {
            method: "POST",
            data: {
...
},{"./callApi":"callApi.js","./cookie":"cookie.js"}],"handleSearchDocs.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.handleSearchDocs = void 0;
var handleSearchDocs = exports.handleSearchDocs = function handleSearchDocs() {
  var searchData = document.querySelector('.search__input').value;
  if (searchData) {
    // history.replaceState(null, '', `${window.location.href}`);
    window.location.href = "".concat(window.location.origin, "/docs?q=").concat(searchData);
  }
};
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var loadDocs = function loadDocs(docs, curPage, docsPerPage) {
  var docsCurPage = docs.slice(curPage * docsPerPage, curPage * docsPerPage + docsPerPage);
  var html = '';
  docsCurPage.map(function (doc, index, docs) {
    html += "\n                <div class=\"card type-box__item docs-page__item\">\n                    <div class=\"card__img\">\n                        <img src=\"/img/ex-1.jpg\" alt=\"docs-img\">\n                    </div>\n                    <div class=\"card__text\">\n                        <h4>\n                            ".concat(doc.name, "\n                        </h4>\n                    </div>\n                    <a href=\"#\" class=\"card__btn\">See all</a>\n                </div>");
  });
  var docsPageContainer = document.querySelector('.docs-page__container');
  docsPageContainer.innerHTML = html;
};
var pagination = exports.pagination = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var html, curPage, totalPage, docsPerPage, dataSearch, url, res, docs, docsPageContainer, _pagination, paginationHtml, i, pageNumberBtn, _i;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          ...
          totalPage = 1;
          docsPerPage = 20;
          dataSearch = window.location.href.slice(window.location.href.indexOf('=') + 1);
          url = "".concat(window.location.origin, "/api/v1/docs/find?q=").concat(dataSearch);
          _context.next = 9;
          return (0, _callApi.callApi)(url, {
            method: "GET"
          });
        case 9:
          ...
          if (!docs || docs.length === 0) {
            ...
            docsPageContainer = document.querySelector('.docs-page__container');
            docsPageContainer.innerHTML = html;
          } else {
            loadDocs(docs, curPage, docsPerPage);
          }
          _pagination = document.querySelector('.docs-page__pagination');
          ...
          if (totalPage <= 1) {
            ...
            for (i = 1; i <= totalPage; i++) {
              paginationHtml += "<li class=\"page-number-btn page-number-".concat(i, "\">").concat(i, "</li>");
            }
            _pagination.innerHTML = paginationHtml;
          }
          pageNumberBtn = document.getElementsByClassName('page-number-btn');
          for (_i = 0; _i < pageNumberBtn.length; _i++) {
            pageNumberBtn[_i].addEventListener('click', function (e) {
...
},{"./callApi":"callApi.js"}],"setAvatar.js":[function(require,module,exports) {
"use strict";
...
var _cookie = require("./cookie");
var setAvatar = exports.setAvatar = function setAvatar() {
  if (!(0, _cookie.getCookieValue)('name')) return;
  var loginBox = document.querySelector('.login__box');
  if (loginBox) {
    document.querySelector('.login__box--1').classList.add("hidden");
    loginBox.innerHTML = "\n            <li class=\"login__box--2\">\n                <a class=\"login__item\">".concat((0, _cookie.getCookieValue)('name'), "</a>\n                <div class=\"avatar\">\n                    <img src=\"/img/avatar.png\" alt=\"\">\n                </div>\n            </li>\n            <div class=\"pop-up hidden\">\n                <ul class=\"pop-up__list\">\n                    <li class=\"pop-up__item pop-up__user-info\">Th\xF4ng tin</li>\n                    <hr />\n                    <li class=\"pop-up__item pop-up--logout\">\n                        <i class=\"fa-solid fa-right-from-bracket\"></i>\n                        \u0110\u0103ng xu\u1EA5t\n                    </li>\n                </ul>\n            </div>\n        ");
  }
};
},{"./cookie":"cookie.js"}],"../../node_modules/js-file-download/file-download.js":[function(require,module,exports) {
...
},{}],"handleDetailPage.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.handleDetailPage = void 0;
var _callApi = require("./callApi");
...
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
function displayDoc() {
  return _displayDoc.apply(this, arguments);
}
function _displayDoc() {
  _displayDoc = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
    var url, docView, pdffile, pages, i, page, pdfCanvas, context, viewport, outputScale, renderContext;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          url = "/pdf/".concat(window.location.pathname.substring(window.location.pathname.lastIndexOf('/') + 1), ".pdf");
          docView = document.querySelector('.doc-view');
          pdfjsLib.GlobalWorkerOptions.workerSrc = 'https://cdn.jsdelivr.net/npm/pdfjs-dist@2.16.105/build/pdf.worker.min.js';
          _context4.next = 5;
          return pdfjsLib.getDocument(url).promise;
        case 5:
          pdffile = _context4.sent;
          console.log(pdffile);
          pages = pdffile._pdfInfo.numPages;
          i = 1;
        case 9:
          if (!(i <= pages)) {
            _context4.next = 25;
...
var viewDetailDoc = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var _response$data, urlFile, url, response, doc, html;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          urlFile = window.location.pathname.substring(window.location.pathname.lastIndexOf('/') + 1);
          url = "".concat(window.location.origin, "/api/v1/docs/").concat(urlFile);
          _context.next = 5;
          return (0, _callApi.callApi)(url, {
            method: "GET"
          });
        case 5:
          response = _context.sent;
          doc = (_response$data = response.data) === null || _response$data === void 0 || (_response$data = _response$data.data) === null || _response$data === void 0 ? void 0 : _response$data.doc;
          html = "\n            <colgroup>\n                <col class=\"col-1\">\n                <col class=\"col-2\">\n            </colgroup>\n            <tr>\n                <td>T\xEAn t\xE0i li\u1EC7u</td>\n                <td>".concat(doc.name, "</td>\n            </tr>\n            <tr>\n                <td>Tr\u01B0\u1EDDng</td>\n                <td>").concat(doc.school, "</td>\n            </tr>\n            <tr>\n                <td>Ng\xE0nh</td>\n                <td>").concat(doc.academic, "</td>\n            </tr>\n            <tr>\n                <td>M\xF4 t\u1EA3 chi ti\u1EBFt</td>\n                <td>...</td>\n            </tr>\n            <tr>\n                <td>\u0110\u1ECBnh d\u1EA1ng</td>\n                <td>PDF</td>\n            </tr>\n            <tr>\n                <td>Dung l\u01B0\u1EE3ng</td>\n                <td>...</td>\n            </tr>");
  ...
  return function viewDetailDoc() {
    return _ref.apply(this, arguments);
  };
}();
var handleDetailPage = exports.handleDetailPage = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 3:
          _context3.next = 5;
          return viewDetailDoc();
        case 5:
          bntDownload = document.querySelector('.btn__download');
          if (bntDownload) {
            bntDownload.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
              var urlFile, url, response;
              return _regeneratorRuntime().wrap(function _callee2$(_context2) {
                while (1) switch (_context2.prev = _context2.next) {
                  case 0:
                    console.log('ok');
                    urlFile = window.location.pathname.substring(window.location.pathname.lastIndexOf('/') + 1);
                    url = "".concat(window.location.origin, "/api/v1/docs/download/").concat(urlFile);
                    _context2.next = 5;
                    return (0, _callApi.callApi)(url, {
                      method: "GET",
                      responseType: "blob"
  ...
  return function handleDetailPage() {
    return _ref2.apply(this, arguments);
  };
}();
},{"./callApi":"callApi.js","js-file-download":"../../node_modules/js-file-download/file-download.js"}],"handleUserPage.js":[function(require,module,exports) {
"use strict";
...
var changePassword = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var _respone$data, _respone$data2, password, newPassword, newPasswordConfirm, url, respone;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          password = document.querySelector('.current-pw').value;
          newPassword = document.querySelector('.new-pw').value;
          newPasswordConfirm = document.querySelector('.new-pw-confirm').value;
        ...
        case 13:
          url = "".concat(window.location.origin, "/api/v1/users/change-pw");
          _context.next = 16;
          return (0, _callApi.callApi)(url, {
            method: "PATCH",
            data: {
        ...
        case 16:
          ...
          if (!(((_respone$data = respone.data) === null || _respone$data === void 0 ? void 0 : _respone$data.status) === "success")) {
            _context.next = 21;
            break;
          }
          ...
          break;
        case 21:
          if (!(((_respone$data2 = respone.data) === null || _respone$data2 === void 0 ? void 0 : _respone$data2.status) === "faild")) {
            _context.next = 23;
            break;
          }
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return (0, _callApi.callApi)('http://localhost:8080/api/v1/users/me', {
            method: "GET"
          });
        case 3:
          response = _context2.sent;
          ...
          return _context2.abrupt("return", (_response$data = response.data) === null || _response$data === void 0 || (_response$data = _response$data.data) === null || _response$data === void 0 ? void 0 : _response$data.user);
        case 7:
          _context2.next = 13;
          break;
        case 9:
...
var handleUserPage = exports.handleUserPage = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
    var userInfo, elements, featureElements, _loop, i, btnChangePw;
    return _regeneratorRuntime().wrap(function _callee3$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 3:
          ...
          featureElements = document.querySelectorAll('.feature');
        ...
        case 10:
          ...
          break;
        case 13:
          btnChangePw = document.querySelector('.btn__change-pw');
          if (btnChangePw) {
  ...
  return function handleUserPage() {
    return _ref3.apply(this, arguments);
  };
}();
},{"./callApi":"callApi.js"}],"index.js":[function(require,module,exports) {
"use strict";

var _handleUploadPage = require("./handleUploadPage");
var _handleLoginPage = require("./handleLoginPage");
var _handleSearchDocs = require("./handleSearchDocs");
var _pagination = require("./pagination");
var _setAvatar = require("./setAvatar");
var _handleDetailPage = require("./handleDetailPage");
var _handleUserPage = require("./handleUserPage");
var userPage = document.querySelector('.user-page');
if (userPage) {
  (0, _handleUserPage.handleUserPage)();
}

// set avatar
var header = document.querySelector('.header');
if (header) {
  (0, _setAvatar.setAvatar)();
}

// handle submit upload file
var btnSubmitUpload = document.querySelector('.btn-submit-upload');
if (btnSubmitUpload) {
  btnSubmitUpload.addEventListener('click', function (e) {
    e.preventDefault();
    (0, _handleUploadPage.handleUploadForm)();
  });
}
...
if (btnSignIn) {
  btnSignIn.addEventListener('click', function (e) {
    e.preventDefault();
    (0, _handleLoginPage.signIn)();
  });
}
//handle submit sign up
var btnSignUp = document.querySelector('.signup__btn');
if (btnSignUp) {
  btnSignUp.addEventListener('click', function (e) {
    e.preventDefault();
    (0, _handleLoginPage.signUp)();
  });
}
...
if (btnSearch) {
  btnSearch.addEventListener('click', function (e) {
    e.preventDefault();
    (0, _handleSearchDocs.handleSearchDocs)();
  });
}
...
var deltaiPage = document.querySelector('.detail-doc-page');
if (deltaiPage) {
  (0, _handleDetailPage.handleDetailPage)();
}
},{"./handleUploadPage":"handleUploadPage.js","./handleLoginPage":"handleLoginPage.js","./handleSearchDocs":"handleSearchDocs.js","./pagination":"pagination.js","./setAvatar":"setAvatar.js","./handleDetailPage":"handleDetailPage.js","./handleUserPage":"handleUserPage.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
